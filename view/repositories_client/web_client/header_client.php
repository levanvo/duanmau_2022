...
<head>
    ...
    <style>
        .levanvo{
            ...
            background-image: url(https://png.pngtree.com/background/20210710/original/pngtree-delicious-japanese-food-h5-material-background-picture-image_1001995.jpg);
...
?>
<body>
    <div class="header_client w-[1300px] flex justify-between mx-auto bg-orange-300">
    ...
    <div class="w-[1300px] flex justify-center space-x-1 mx-auto relative">
        <div class="w-[296px] header_client h-[700px] text-gray-200 select_client">
            <h1 class="font-bold text-2xl text-center underline mb-1 text-white ml-2 mt-5">------- Profile -------</h1>
            <div class="profile text-center mb-5 mt-5">
            ...
            <div class=" mb-5 vovan w-48 mx-auto">
                <div><a href="index.php?client=dashboard" class="flex justify-center space-x-2 w-48 mx-auto bg-white text-black"><img class="mt-[2px] w-4 h-4 my-auto img_icon" src="../../img/img_icon/dashboard.png" alt=""></div>
                <p class="text1">Dash board</p></a>
            </div>

            <div class=" mb-5 vovan w-48 mx-auto">
                <div><a href="index.php?client=cart" class="flex justify-center space-x-2 w-48 mx-auto bg-white text-black"><img class="mt-[2px] w-5 h-5 my-auto img_icon" src="../../img/img_icon/cart.png" alt=""></div>
                <p class="text1">Cart</p></a>
            </div>

            <div class=" mb-5 vovan w-48 mx-auto">
                <div><a href="index.php?client=history_buy" class="flex justify-center space-x-2 w-48 mx-auto bg-white text-black"><img class="mt-[2px] w-5 h-5 my-auto img_icon" src="../../img/img_icon/history_buy.png" alt=""></div>
                <p class="text1">Purchase history</p></a>
            </div>
        </div>
    <!-- Relationship -->
